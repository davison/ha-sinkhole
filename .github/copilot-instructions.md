...
Consume all of the markdown files in the project root directory and the root of each container context directory in order to add context to all code suggestions.
